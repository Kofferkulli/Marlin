...
#define STRING_CONFIG_H_AUTHOR "(Kofferkulli, Ender-3)" // Who made the changes.
...
#define Z_SERVO_ANGLES {200,124}  // Z Servo Deploy and Stow angles
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -16, -1.09 }
...
#define X_MIN_POS 0
#define Y_MIN_POS -15 //-15 for glass
#define Z_MIN_POS 0
#define X_MAX_POS (X_BED_SIZE + 13)
#define Y_MAX_POS 220 //220 for glass, Y_BED_SIZE else
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 1          // Set Mesh bounds as an inset region of the bed
  #define GRID_MAX_POINTS_X 35    // Don't use more than 7 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
